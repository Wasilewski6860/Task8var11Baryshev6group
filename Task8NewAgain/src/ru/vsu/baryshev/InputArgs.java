...
public class InputArgs {
    ...
    public static PrintStream createOfPrintStream() throws FileNotFoundException {
        out.println("Where would you save? ");
        PrintStream pw = new PrintStream(new File(testOfReadingWithAsking()));
        return pw;
    }
